...
export class ContactService {
    ...
    public query() {
        ...
        this._contacts$.next(contacts.reverse())
    }
    ...
    public save(contact: ContactModel) {
        return contact._id ? this._edit(contact) : this._add(contact)
    }

    private _add(contact: ContactModel) {
    ...
    private _edit(contact: ContactModel) {
    ...
    private _addContact(contact: ContactModel) {
        //mock the server work
        const newContact = new ContactModel(contact.name, contact.email, contact.phone);
